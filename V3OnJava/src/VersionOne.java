...
//      third variant
        ...
        StringTokenizer tk1=new StringTokenizer(input,"0x0D0x0A");
        while(tk1.hasMoreTokens()){
            temp1.add(tk1.nextToken());
        }
        for(String input2:temp1) {
            StringTokenizer tk2 = new StringTokenizer(input2, "0x0D");
            while (tk2.hasMoreTokens()) {
                temp2.add(tk2.nextToken());
            }
        }
        for(String input3:temp2) {
            StringTokenizer tk3 = new StringTokenizer(input3, "0x0A");

            while (tk3.hasMoreTokens()) {
                temp3.add(tk3.nextToken());
            }
        }
        lines=temp3;
